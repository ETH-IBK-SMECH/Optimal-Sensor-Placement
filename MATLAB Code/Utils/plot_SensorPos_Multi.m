function plot_SensorPos_Multi(Results,Coord,atyp,ns,~,jointNo,as,al,flg,lambda)
%Function to visualize the final position of the sensors (multi-axial)
...
title('Monitored DOFs (biaxial (calculated))','Fontsize',Fontsize+1,'Interpreter','latex');
end
...
% print -painters -depsc -r600 'SensorPos_EFI.eps'
elseif ns==6 && strcmp(flg,'mke')
% print -painters -depsc -r600 'SensorPos_MKE.eps'
elseif (ns==6 && strcmp(flg,'iei') && lambda==0.001)
% print -painters -depsc -r600 'Z:SensorPos_IEI_00.eps'
elseif (ns==6 && strcmp(flg,'iei') && lambda==0.5)
% print -painters -depsc -r600 'SensorPos_IEI_05.eps'
elseif (ns==6 && strcmp(flg,'iei') && lambda==1.0)
% print -painters -depsc -r600 'SensorPos_IEI_10.eps'
elseif strcmp(flg,'iei') && lambda==1.5
% print -painters -depsc -r600 'SensorPos_IEI_Multi.eps'
end
end